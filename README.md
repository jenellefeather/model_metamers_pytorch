...
Installation Guide
==================
The python module versions used for the analysis in Feather et al. 2023 are output into [feather_metamers_conda_2022.yml](feather_metamers_conda_2022.yml). Using conda, this environmental can be created with the following: 
...
## Testing Environment
All code for Feather et al. 2023 was run and tested on the [MIT OpenMind Computing Cluster](https://openmind.mit.edu/) with the CentOS Linux 7 (Core) operating system. Model training and metamer generation relies on GPUs. Metamer generation was performed on NVIDIA GPUs with a minimum of 11 GB of RAM. GPUs used for model training are further documented for [visual models](model_analysis_folders/visual_networks/pytorch_checkpoints/README) and [auditory models](model_analysis_folders/audio_networks/pytorch_checkpoints/README).
...
results in Feather et al. 2023. Figure generation for data presented in main-text figures are included in notebooks documented below. 
...
[Feather, J., Leclerc, G., Mądry, A., & McDermott, J. H. (2023). Model metamers illuminate divergences between biological and artificial neural networks. bioRxiv.](https://www.biorxiv.org/content/10.1101/2022.05.19.492678v1)

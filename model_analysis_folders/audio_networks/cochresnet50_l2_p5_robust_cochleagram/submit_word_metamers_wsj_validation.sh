...
#SBATCH --exclude=node093,node040,node094,node097,node098,node038,node037,dgx001
...
python make_metamers_wsj400_behavior_only_save_metamer_layers.py $SLURM_ARRAY_TASK_ID -I 3000 -N 8

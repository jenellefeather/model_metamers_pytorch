...
python make_null_distributions.py -N 50000 -I 5 -R 0 --no-shuffle &
python make_null_distributions.py -N 50000 -I 6 -R 0 --no-shuffle &
python make_null_distributions.py -N 50000 -I 7 -R 0 --no-shuffle &
python make_null_distributions.py -N 50000 -I 8 -R 0 --no-shuffle &
python make_null_distributions.py -N 50000 -I 9 -R 0 --no-shuffle &

...
python make_null_distributions.py -N 50000 -I 15 -R 0 --no-shuffle &
python make_null_distributions.py -N 50000 -I 16 -R 0 --no-shuffle &
python make_null_distributions.py -N 50000 -I 17 -R 0 --no-shuffle &
python make_null_distributions.py -N 50000 -I 18 -R 0 --no-shuffle &
python make_null_distributions.py -N 50000 -I 19 -R 0 --no-shuffle &
